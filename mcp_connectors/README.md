...
```bash
/Users/Developer/Github/agent/venv/bin/python -m pip install mcp
```

## Quick self-check

```bash
cd /Users/Developer/Github/agent
/Users/Developer/Github/agent/venv/bin/python mcp_connectors/lmstudio_engine_tools_bridge.py --self-check
```
...
```bash
cd /Users/Developer/Github/agent
/Users/Developer/Github/agent/venv/bin/python mcp_connectors/lmstudio_engine_tools_bridge.py --profile safe
```
...
```bash
cd /Users/Developer/Github/agent
/Users/Developer/Github/agent/venv/bin/python mcp_connectors/lmstudio_engine_tools_bridge.py --profile full
```
...
```bash
/Users/Developer/Github/agent/venv/bin/python mcp_connectors/lmstudio_engine_tools_bridge.py --include web_search,web_fetch,query_memory
```

Exclude tools:

```bash
/Users/Developer/Github/agent/venv/bin/python mcp_connectors/lmstudio_engine_tools_bridge.py --profile full --exclude bash,file_str_replace
```
...
- Command: `/Users/Developer/Github/agent/venv/bin/python`
- Args:
  - `/Users/Developer/Github/agent/mcp_connectors/lmstudio_engine_tools_bridge.py`
  - `--profile`
  - `safe`
